...
(async () => {
  ...
  await page.screenshot({ path: 'C:/Users/yanxi/Documents/OKRManage/tmp/goal-page-expanded.png', fullPage: true });
  ...
  if (popup) {
    ...
    await popup.screenshot({ path: 'C:/Users/yanxi/Documents/OKRManage/tmp/zip-popup.png', fullPage: true });
  } else {
    console.log('NO_POPUP');
    console.log('PAGE_TEXT', (await page.locator('body').innerText()).slice(0, 1200));
    await page.screenshot({ path: 'C:/Users/yanxi/Documents/OKRManage/tmp/zip-same-page-after-click.png', fullPage: true });
  }
